#!/usr/bin/env python3
"""MOCK of the Acme project tracker MCP server, backed by a throwaway SQLite file.

Tool surface (names, params, descriptions) and behavioral quirks mirror the
production server exactly: key-vs-id inconsistency on create_task, title-only
search, page size 5 with next_cursor, ERR_409 on done-without-assignee,
ERR_403 on assigning suspended users. Safe for agents to write to freely.
"""
import sqlite3
