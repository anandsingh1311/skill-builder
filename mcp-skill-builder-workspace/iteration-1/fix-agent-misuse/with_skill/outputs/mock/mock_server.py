#!/usr/bin/env python3
"""MOCK of the Acme project tracker MCP server.

Identical tool surface and behavior (same names, params, error strings, quirks,
pagination) as the production server, but backed by a throwaway SQLite file in
this directory. Safe for agents to write to.
"""
import sqlite3
